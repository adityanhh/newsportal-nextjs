                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute right-0 mt-2 w-48 bg-white text-black rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <a href="#" className="block px-4 py-2 hover:bg-blue-500 hover:text-white transition">Profile</a>
                            <a href="#" className="block px-4 py-2 hover:bg-blue-500 hover:text-white transition">Settings</a>
                            <a href="#" className="block px-4 py-2 hover:bg-blue-500 hover:text-white transition">Logout</a>
                        </div>
                    </div>
                </div>
            </div>
